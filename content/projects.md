...
We argue that, for certain classification tasks, a network's skip connections are needed for the network to learn but not necessary for inference after convergence. 
We thus introduce *Tailor*, a retraining method that alters skip connections in a fully-trained network to mitigate their hardware cost.
